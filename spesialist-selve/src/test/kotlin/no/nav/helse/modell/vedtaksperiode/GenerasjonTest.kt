...
internal class GenerasjonTest: AbstractDatabaseTest() {
    ...
    fun `structural equals`() {
        ...
        generasjon1.håndterOppdatertBehandlingsinformasjon(emptyList(), spleisBehandlingId)
        generasjon1.håndterVedtakFattet(UUID.randomUUID())
        val generasjon2 = generasjon(generasjonId, vedtaksperiodeId)
        generasjon2.håndterOppdatertBehandlingsinformasjon(emptyList(), spleisBehandlingId)
    ...
    @Test
    fun `forskjellig spleisBehandlingId`() {
        val generasjonId = UUID.randomUUID()
        val vedtaksperiodeId = UUID.randomUUID()
        val generasjon1 = generasjon(generasjonId, vedtaksperiodeId)
        val spleisBehandlingId = UUID.randomUUID()
        generasjon1.håndterOppdatertBehandlingsinformasjon(listOf("hei"), spleisBehandlingId)
        val generasjon2 = generasjon(generasjonId, vedtaksperiodeId)
        val spleisBehandlingId2 = UUID.randomUUID()
        generasjon2.håndterOppdatertBehandlingsinformasjon(listOf("hallo"), spleisBehandlingId2)
        assertNotEquals(generasjon1, generasjon2)
        assertNotEquals(generasjon1.hashCode(), generasjon2.hashCode())
    }
    ...
    fun `generasjon toDto`() {
        ...
        generasjon.håndterOppdatertBehandlingsinformasjon(tags, spleisBehandlingId)
