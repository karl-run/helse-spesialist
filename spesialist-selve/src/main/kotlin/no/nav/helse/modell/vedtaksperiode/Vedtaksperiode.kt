...
internal class Vedtaksperiode(
    ...
    fun oppdaterBehandlingsinformasjon(tags: List<String>, spleisBehandlingId: UUID) =
        gjeldendeGenerasjon.håndterOppdatertBehandlingsinformasjon(tags, spleisBehandlingId)
